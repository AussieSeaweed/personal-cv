...
\begin{document}
	...
	\begin{etaremune}
		\item \textbf{J. Kim} (2024). Recording and Describing Poker Games. In: \textit{2024 IEEE Conference on Games (CoG)}. {\small (Oral, acceptance rate: 41.1\%)} % DOI: \href{https://doi.org/10.1109/CoGTODO}{10.1109/CoGTODO}.
	...
	\begin{itemize}
		...
		\item Cardroom: A Django application for poker tournament and table management. {\small GitHub: \url{https://github.com/uoftcprg/cardroom}.}
                \item PRiVaTe: PRiVaTe: Python implementations of variance reduction techniques for extensive-form games. {\small GitHub: \url{https://github.com/uoftcprg/private}.}
		\iftoggle{verbose}{
