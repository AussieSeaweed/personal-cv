...
\begin{document}
	...
	\begin{etaremune}
		...
		\item \textbf{J. Kim}, M. Guerzhoy (2024). Observing the Southern US Culture of Honor Using Large-Scale Social Media Analysis. In: \textit{10\textsuperscript{th} International Conference on Computational Social Science IC\textsuperscript{2}S\textsuperscript{2}}. \iftoggle{verbose}{\small (Poster, acceptance rate: 88.6\%)}
	\end{etaremune}
