...
\begin{document}
	...
	\begin{etaremune}
		\item \textbf{J. Kim} and M. Guerzhoy (2024). \href{https://doi.org/10.18653/v1/2024.sicon-1.1}{Observing the Southern US Culture of Honor Using Large-Scale Social Media Analysis}. In: \textit{Proceedings of the Workshop on Social Influence in Conversations (SICon)}.
	\end{etaremune}
	...
	\begin{tabularx}{\textwidth}{r X}
		...
		08/2031 -- Present & \textit{Graduate Research Assistant} \\
		\addlinespace
