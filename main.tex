% TODO: 'We have featured your paper "Parallelizing Counterfactual Regret Minimization" today on dailypapers.io.'
...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{r X}
		...
		& {\small Advisor: \href{https://www.cs.cmu.edu/~sandholm/}{Tuomas Sandholm}} \\*
		\addlinespace
		& \textbf{\href{https://www.utoronto.ca/}{University of Toronto}} \\*
		09/2019 -- 06/2025 & \textit{Bachelor of Applied Science in Engineering Science (with honours\iftoggle{verbose}{, CGPA: 3.57/4.00}{})} \\*
		& {\small Major in Machine Intelligence\iftoggle{verbose}{ (GPA: 3.82/4.00)}{}} \\*
		& {\small Thesis: Observing the Southern US Honor Culture Using Large-Scale Social Media Analysis} \\*
		& {\small Advisor: \href{http://www.cs.toronto.edu/~guerzhoy/}{Michael Guerzhoy}} \\*
		\iftoggle{verbose}{
			\addlinespace
	...
	\begin{etaremune}
		\item \textbf{J. Kim} (2025). \href{https://doi.org/10.1017/psrm.2026.10121}{Racialization of the Democratic Peace in Foundational Embedding Models}. In: \textit{Political Science Research and Methods (PSRM)}.
		\item \textbf{J. Kim} (2023). \href{https://doi.org/10.1109/TG.2023.3325637}{PokerKit: A Comprehensive Python Library for Fine-Grained Multi-Variant Poker Game Simulations}. In: \textit{IEEE Transactions on Games}.
	\end{etaremune}

	\subsection*{Conferences}

	\begin{etaremune}
		\item \textbf{J. Kim}, \href{https://feifang.info/}{F. Fang}, and \href{https://www.cs.cmu.edu/~sandholm/}{T. Sandholm} (2026). Watermarking Game-Playing Agents in Perfect-Information Extensive-Form Games. In: \textit{Proceedings of the Annual Conference on Neural Information Processing Systems (NeurIPS)}. (Acceptance rate: 25.7\%)
		\item \textbf{J. Kim} (2025). \href{https://doi.org/10.1109/CoG64752.2025.11114139}{Empirical Validation of the Independent Chip Model}. In: \textit{Proceedings of the IEEE Conference on Games (CoG)}. (Short paper, acceptance rate: 42\%)
		\item \textbf{J. Kim} (2024). \href{https://doi.org/10.1109/CoG60054.2024.10645611}{Recording and Describing Poker Games}. In: \textit{Proceedings of the IEEE Conference on Games (CoG)}. (Acceptance rate: 41.1\%)
	\end{etaremune}

	\subsection*{Workshops}

	\begin{etaremune}
		\item \textbf{J. Kim} and \href{https://www.cs.toronto.edu/~guerzhoy/}{M. Guerzhoy} (2024). \href{https://doi.org/10.18653/v1/2024.sicon-1.1}{Observing the Southern US Culture of Honor Using Large-Scale Social Media Analysis}. In: \textit{Proceedings of the Workshop on Social Influence in Conversations (SICon)}.
	\end{etaremune}

	\subsection*{Working Papers}

	\begin{etaremune}
		\item \textbf{J. Kim} and \href{https://www.cs.cmu.edu/~sandholm/}{T. Sandholm} (2026). \href{https://doi.org/10.48550/arXiv.2608.14977}{Watermarked Game Solving via Perturbed Regret Minimization}.
		\item \textbf{J. Kim} and \href{https://www.cs.cmu.edu/~sandholm/}{T. Sandholm} (2026). \href{https://doi.org/10.48550/arXiv.2605.15543}{Domain-Independent Game Abstraction using Word Embedding Techniques}.
		\item \textbf{J. Kim} and \href{https://www.cs.cmu.edu/~sandholm/}{T. Sandholm} (2026). \href{https://doi.org/10.48550/arXiv.2605.14277}{Parallelizing Counterfactual Regret Minimization}.
		\item \textbf{J. Kim} and \href{https://www.cs.cmu.edu/~sandholm/}{T. Sandholm} (2026). \href{https://doi.org/10.48550/arXiv.2605.14261}{Heuristic Pathologies and Further Variance Reduction via Uncertainty Propagation in the AIVAT Family of Techniques}.
		\iftoggle{verbose}{
			\item \textbf{J. Kim} (2025). \href{https://doi.org/10.48550/arXiv.2408.14778}{GPU-Accelerated Counterfactual Regret Minimization}.
			\item A. Raeisdanaei, \textbf{J. Kim}, M. Liao, and S. Kochhar (2025). \href{https://doi.org/10.48550/arXiv.2503.12043}{An LLM-Integrated Framework for Completion, Management, and Tracing of STPA}.
			\item \textbf{J. Kim} (2023). \href{https://doi.org/10.48550/arXiv.2311.07623}{PadChannel: Improving CNN Performance through Explicit Padding Encoding}.
		}{}
	\end{etaremune}
	...
	\iftoggle{verbose}{
		...
		\begin{etaremune}
			\item \textbf{J. Kim}, M. Guerzhoy (2024). Observing the Southern US Culture of Honor Using Large-Scale Social Media Analysis. In: \textit{10\textsuperscript{th} International Conference on Computational Social Science IC\textsuperscript{2}S\textsuperscript{2}}. (Extended abstract, poster, acceptance rate: 88.6\%)
			\item \textbf{J. Kim} (May 16, 2024). Variance Reduction Techniques and their Applications to Poker. In: \textit{AceGuardian Seminar}.
		\end{etaremune}
	}{}
	...
	\begin{tabularx}{\textwidth}{r X}
		& \textbf{\href{https://www.cs.cmu.edu/}{Carnegie Mellon University School of Computer Science}} \\*
		08/2025 -- Present & \textit{Research Assistant} \\
		\addlinespace
	...
	\iftoggle{verbose}{
		...
		\begin{itemize}[noitemsep]
			\item PokerKit: An open-source Python library for poker game simulations, hand evaluations, and statistical analysis. GitHub: \href{https://github.com/uoftcprg/pokerkit}{uoftcprg/pokerkit}.
			\item GPUGT: GPU parallelizable implementation of counterfactual regret minimization. GitHub: \href{https://github.com/uoftcprg/gpugt}{uoftcprg/gpugt}.
			\item Cardroom: A Django application for poker tournament and table management. GitHub: \href{https://github.com/uoftcprg/cardroom}{uoftcprg/cardroom}.
			\item PVAT: Python implementations of variance reduction techniques for extensive-form games. GitHub: \href{https://github.com/uoftcprg/pvat}{uoftcprg/pvat}.
			\item PokerCMD: Command line tools for poker-related calculations. GitHub: \href{https://github.com/uoftcprg/pokercmd}{uoftcprg/pokercmd}.
			\item Revolution: The software for the next generation electrical system for Blue Sky Solar Racing. GitHub: \href{https://github.com/blueskysolarracing/revolution}{blueskysolarracing/revolution}.
			\item BattLib: A library for battery SOC calculation using EKF. GitHub: \href{https://github.com/blueskysolarracing/battlib}{blueskysolarracing/battlib}.
			\item ICLib: A collection of integrated circuit libraries in pure Python. GitHub: \href{https://github.com/blueskysolarracing/iclib}{blueskysolarracing/iclib}.
			\item Door: A comprehensive Python library for synchronization proxies. GitHub: \href{https://github.com/blueskysolarracing/door}{blueskysolarracing/door}.
			\item Borealis: Blue Sky Solar Racing's Gen11 vehicle compute platform. GitHub: \href{https://github.com/blueskysolarracing/borealis}{blueskysolarracing/borealis}.
			\item RITC: A Python library for interacting with the Rotman Interactive Trader Market Simulator Client Application. GitHub: \href{https://github.com/AussieSeaweed/ritc}{AussieSeaweed/ritc}.
			\item math2: A Python package for various math functions. GitHub: \href{https://github.com/AussieSeaweed/math2}{AussieSeaweed/math2}.
			\item Snek AI: An AI program that plays the snek game. GitHub: \href{https://github.com/AussieSeaweed/snek-ai}{AussieSeaweed/snek-ai}.
			\item Data Structure Visualization: A visualization of a binary search tree, created using processing. GitHub: \href{https://github.com/AussieSeaweed/data-structure-visualization}{AussieSeaweed/data-structure-visualization}.
			\item Zombies and Monies: A top-down 2D zombie shooter game. GitHub: \href{https://github.com/AussieSeaweed/zombies-and-monies}{AussieSeaweed/zombies-and-monies}.
			\item Tank Game Offline: A top-down 2D tank shooter game. GitHub: \href{https://github.com/AussieSeaweed/tank-game-offline}{AussieSeaweed/tank-game-offline}.
			\item Crimson: A simple 3D object viewer. GitHub: \href{https://github.com/AussieSeaweed/crimson}{AussieSeaweed/crimson}.
			\item Chess Classic: A Modern Chess GUI. GitHub: \href{https://github.com/AussieSeaweed/chess-classic}{AussieSeaweed/chess-classic}.
		\end{itemize}

		\subsection*{Standards}

		\begin{itemize}[noitemsep]
			\item Poker Hand History File Format Specification. GitHub: \href{https://github.com/uoftcprg/phh-std}{uoftcprg/phh-std}.
		\end{itemize}

		\subsection*{Datasets}

		\begin{itemize}[noitemsep]
			\item Poker Hand Histories: A dataset of poker hand histories. GitHub: \href{https://github.com/uoftcprg/phh-dataset}{uoftcprg/phh-dataset}.
		\item Poker Hand Strengths: A dataset of poker hand strengths. GitHub: \href{https://github.com/uoftcprg/phs-dataset}{uoftcprg/phs-dataset}.
			\item Poker Statistical Analyses: A dataset of poker statistical analysis calculations. GitHub: \href{https://github.com/uoftcprg/psa-dataset}{uoftcprg/psa-dataset}.
			\item Poker Tournaments: A dataset of poker tournaments. GitHub: \href{https://github.com/uoftcprg/pt-dataset}{uoftcprg/pt-dataset}.
		\end{itemize}

		\subsection*{Websites}

		\begin{itemize}[noitemsep]
			\item University of Toronto Poker Club. GitHub: \href{https://github.com/uoftcprg/uoftpoker-website}{uoftcprg/uoftpoker-websit}.
			\item Universal, Open, Free, and Transparent Computer Poker Research Group. GitHub: \href{https://github.com/uoftcprg/uoftcprg-website}{uoftcprg/uoftcprg-websit}.
			\item Personal Website: My personal website. GitHub: \href{https://github.com/AussieSeaweed/personal-website}{AussieSeaweed/personal-websit}.
		\end{itemize}
	}{
		\begin{itemize}[noitemsep]
			\item PokerKit: An open-source Python library for poker game simulations, hand evaluations, and statistical analysis. GitHub: \href{https://github.com/uoftcprg/pokerkit}{uoftcprg/pokerkit}.
	...
	\begin{itemize}[noitemsep]
		...
		\item Email: \href{mailto:juhok@cs.cmu.edu}{juhok@cs.cmu.edu}.
