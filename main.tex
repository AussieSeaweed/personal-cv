...
\begin{document}
	...
	\begin{etaremune}
		\item \textbf{J. Kim} (2025). Racialization of the Democratic Peace in Foundational Embedding Models. In: \textit{Political Science Research and Methods (PSRM)}. (Conditionally accepted, pending replication)
